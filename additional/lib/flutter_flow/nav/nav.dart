...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'ChooseAccType',
          path: '/chooseAccType',
          builder: (context, params) => ChooseAccTypeWidget(),
        ),
        FFRoute(
          name: 'StudentSignUp',
          path: '/studentSignUp',
        ...
        FFRoute(
          name: 'CompanySignUp',
          path: '/companySignUp',
          builder: (context, params) => CompanySignUpWidget(),
        ),
        FFRoute(
          name: 'PrivacyPolicy',
          path: '/privacyPolicy',
        ...
        FFRoute(
          name: 'InternPage',
          path: '/internPage',
          builder: (context, params) => InternPageWidget(),
        ),
        FFRoute(
          name: 'SendRequestPage',
          path: '/sendRequestPage',
          builder: (context, params) => SendRequestPageWidget(),
        )
