...
class _StudentSignUpWidgetState extends State<StudentSignUpWidget> {
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              onChanged: (username) async {
                                                final isUnique =
                                                    await _isUsernameUniqueInFirestore(
                                                        username);
                                                setState(() {
  ...
  Future<bool> _isUsernameUniqueInFirestore(String username) async {
    try {
      ...
      // If there are no documents returned, the username is unique.
      return query.docs.isEmpty;
    } catch (e) {
      print('Error checking username uniqueness: $e');
      return false; // Assume it's not unique in case of an error.
    }
  }
}
